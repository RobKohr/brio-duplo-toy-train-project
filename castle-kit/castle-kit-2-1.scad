...
sept./dec. 2012
minor adaptions sept 2015 / feb 2017 / nov 2018
...
1. First, look at ../examples_castle_kit/castle_generation.scad
...
module tower_round_structure (scale=SCALE)
{
	...
	union () {
		...
		block   (-6, -2,  FLOOR_TOP,  10,    4,     3*FULL,   false, scale=scale) ;
